...
\qauthor{Antoine de Saint-Exupéry}
\end{savequote}
...
\section{Time division and planning}\label{sec:time_planning}
	...
	As can be seen in the Gantt chart, there are some tasks that overlap in time: for example the \Quote{Study of the Atlassian suite} overlaps with Configuration of the environment tools.
