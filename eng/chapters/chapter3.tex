	...
	\subsubsection{Spotify}
		...
		\begin{minipage}[c]{0.70\textwidth}
			...
			\begin{figure}[H]
				...
				\caption{The \Quote{Spotify Tribe Engineering Model}}
			\end{figure}
		\end{minipage}\\
...
\section{Time cycles and metrics}\label{sec:metrics}
...
\section{Disadvantages of Agile Software Development}
	...
	\end{enumerate}
	The following image contains the percentages that, in VersionOne's previously presented survey on the \Quote{State of Agile}\cite{state-of-agile}, represent some of the most cited \Quote{Challenges Experienced Adopting \& Scaling Agile}:
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{resources/disa}}%
		\caption{Some of the \Quote{Challenges Experienced Adopting \& Scaling Agile}}
	\end{figure}
...
\section{What Agile variant Athonet uses}
	...
	As said in \Chapref{chapter_5}, the managers were keen on the idea of Kanban because it allows employees to \Quote{come in the morning and choose what they want to work on from the backlog}, as said by the development team manager, without giving them a two week period of time but letting them complete the tasks in time for the following release.
