...
%todo Andando a vedere i contenuti di questa parte non mi soddisfano molto. Ce troppo scritto e poco di tecnico. Parla meglio un diagrama che 10 pagine di scritto.
%todo Di solito, per queste tipologie di lavori, consiglio di seguire un approccio top-down. Espongo un diagramma (di qualsiasi natura) che racconta l'intera soluzione e blochi che la compongono e poi vado a parlarti di alcuni di questi blochi e come si incastrano. 
...
\section{Initial installation and configuration}	
	...
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{resources/Annotation2019-07-24171359}}%
