...
%	              {\includegraphics[width=6.2cm]{\logoFacultadPortadaBaja}};
	...
	\begin{textblock*}{\textwidth}(1cm,-2.3cm)% Ancho - Pos X,PosY
		...
		\\[\TamOtrosIn]
		{\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white}\textbf{Matriculation number: 1143057}}
		\\\\[\TamOtrosIn]
		{\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white} Supervisor: Armir Bujari}
		\\[\TamOtrosIn]
