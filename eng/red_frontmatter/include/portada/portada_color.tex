...
%	              {\includegraphics[width=6.2cm]{\logoFacultadPortadaBaja}};
	...
	\begin{textblock*}{\textwidth}(1cm,-2.3cm)% Ancho - Pos X,PosY
		...
		\\[\TamTrabajoIn] 
		{\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white} Candidate:}
		[\TamOtrosIn]
		{\hspace{-1cm}\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white}\miNombre}
		\\[\TamOtrosIn]		
		{\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white}\textbf{Number of immatriculation: 1143057}}
		\\\\[\TamOtrosIn]
		{\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white} Supervisor:}
		[\TamOtrosIn]
		{\hspace{-1cm}\FuentePortada \fontsize{\TamOtros}{30pt}\selectfont\color{white}\miTutor}
		\\[\TamOtrosIn]
		\\[\TamOtrosIn]		
