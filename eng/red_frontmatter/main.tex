...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Supporting tools for ~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Agile software development:}
\newcommand{\subtitulo}{Experience from a real use case}
% Datos del autor
\newcommand{\miNombre}{Ciprian Stefan Voinea}
\newcommand{\miDNI}{1143057}
\newcommand{\miEmail}{stefanciprian.voinea@studenti.unipd.it}
% Datos del tutor/es
\newcommand{\miTutor}{Armir Bujari}
...
\newcommand{\miUniversidad}{\protect{Università degli Studi di Padova}}
...
\newcommand{\logoUniversidadPortada}{include/logos-universidad/unipd-white}
...
% Texto
\newcommand{\miGrado}{Bachelor's degree}
\newcommand{\tipotrabajo}{Bachelor's Degree thesis in Computer Science}
% Color
